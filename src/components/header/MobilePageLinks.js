...
const MobilePages = () => {
    return (
        <div className="mobile-pages-main">
                ...
                <br/>
                <br/>
                <li className="d-inline p-4"><Link to="/"><span className="text-dark" >Blog</span></Link></li>
                <li className="d-inline p-4"><Link to="/vlog"><span className="text-dark">Vlog</span></Link></li>
